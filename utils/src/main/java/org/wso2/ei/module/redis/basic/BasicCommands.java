...
package org.wso2.ei.module.redis.basic;

public class BasicCommands {

//    public static String echo(String message) throws BallerinaRedisException {
...
//        BString result = echo(message, redisDataSource);
//        try {
